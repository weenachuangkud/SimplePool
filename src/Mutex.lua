...
- Description : A simple mutex class for synchronizing access to shared resources.
]]

-- very simple mutex implementation :D
...
function Mutex.new()
	local self = (setmetatable({}, Mutex) :: any) :: Mutex
	self.locked = false
